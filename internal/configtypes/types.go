...
type Token struct {
	...
	HMACSecretKeyBackup []string `mapstructure:"hmac_secret_key_backup" json:"hmac_secret_key_backup" envconfig:"hmac_secret_key_backup" yaml:"hmac_secret_key_backup" toml:"hmac_secret_key_backup"`
