...
func newRegistry(cfg Config) (*Registry, error) {
	...
	m.channelSubscribeTotal = prometheus.NewCounterVec(prometheus.CounterOpts{
		...
		Help:        "Total number of successful channel subscriptions, labeled by namespace and user.",
		ConstLabels: constLabels,
	...
	m.channelUnsubscribeTotal = prometheus.NewCounterVec(prometheus.CounterOpts{
		...
		Help:        "Total number of channel unsubscriptions, labeled by namespace and user.",
		ConstLabels: constLabels,
	}, []string{"namespace", "user"})
	...
	m.channelPublishTotal = prometheus.NewCounterVec(prometheus.CounterOpts{
		...
		Subsystem:   "channel",
		Name:        "publish_total",
		Help:        "Total number of successful client-side channel publications, labeled by namespace and user.",
		ConstLabels: constLabels,
	}, []string{"namespace", "user"})
